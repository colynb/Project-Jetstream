...
class SplClassLoader {
	...
	public function loadClass($className) {
		...
		if ( null === $this->_namespace || strtolower($this->_namespace . $this->_namespaceSeparator) === strtolower(substr($className, 0, strlen($this->_namespace . $this->_namespaceSeparator))) ) {
